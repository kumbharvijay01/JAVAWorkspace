 ...
 public class Dbconn {
            ...
            
    {
        try{
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/housingsoc","root","root");  
         System.out.println("Getting Driver");
        //Connection con = DriverManager.getConnection("jdbc:odbc:Driver={MicroSoft Access Driver (*.mdb)};DBQ=E:\\java_projects\\inventry_erp\\inventry_erp.mdb","","");
        return con;
        }
