...
<head>
  <title>Home| Unique Housing Society</title>
    ...
    <header>
      <div id="logo">
        <div id="logo_text">
          ...
          <h1><a href="index.jsp"><img src="images/uniquelogo.png" height="40px" width="40px">nique<span class="logo_colour">&nbsp;Housing Society</span></a></h1>
